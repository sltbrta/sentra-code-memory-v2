...
func crossCheckPeer(peer localauthority.PeerContext, caller *contractsv1.UntrustedQueryCaller) (Principal, error) {
...
// descriptors before return: a grounded fact can never coexist with a
// rejection, and a defect fails closed instead of serving invalid contracts.
